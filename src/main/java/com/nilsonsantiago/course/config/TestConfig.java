...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2025-10-23T10:45:30Z"), u1);
		Order o2 = new Order(null, Instant.parse("2025-10-24T12:45:20Z"), u2);
		Order o3 = new Order(null, Instant.parse("2025-10-25T23:30:25Z"), u1);
